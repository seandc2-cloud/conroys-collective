    ...
    <main style={{ padding: "40px", fontFamily: "Arial, sans-serif" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <a 
            href="/checkout?product=Smart%20Posture%20Trainer&price=49.99"
            style={{
              marginTop: "15px",
              padding: "12px 20px",
              fontSize: "16px",
        ...
        <div style={{
          ...
          <a 
            href="/checkout?product=Smart%20Neck%20Relaxer&price=59.99"
            style={{
              marginTop: "15px",
              padding: "12px 20px",
              fontSize: "16px",
        ...
        <div style={{
          ...
          <a 
            href="/checkout?product=Smart%20Back%20Support%20Belt&price=69.99"
            style={{
              marginTop: "15px",
              padding: "12px 20px",
              fontSize: "16px",
        ...
        <div style={{
          ...
          <a 
            href="/checkout?product=Smart%20Shoulder%20Massager&price=79.99"
            style={{
              marginTop: "15px",
              padding: "12px 20px",
              fontSize: "16px",
